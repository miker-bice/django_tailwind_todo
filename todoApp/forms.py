    ...
    class Meta:
        ...
        widgets = {
            'item': forms.TextInput(attrs={
                'class': "bg-gray-50 mb-4 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 "
                         "focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 "
                         "dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 "
                         "dark:focus:border-blue-500"}),
            'description': forms.Textarea(attrs={
                'class': "block mb-4 p-2.5 w-full text-md text-gray-900 bg-gray-50 "
            ...
            'complete': forms.CheckboxInput(attrs={
                'class': "ml-6 w-4 h-4 bg-gray-50 rounded border "
                         "border-gray-300 "
